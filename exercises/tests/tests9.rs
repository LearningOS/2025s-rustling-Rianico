...
// externally imported function would follow. In this exercise, "Rust" is used,
// while other variants exists like "C" for standard C ABI, "stdcall" for the
// Windows ABI.
//
...
// for `my_demo_function`, so the two line of code in the testcase should call
// the same function.
//
